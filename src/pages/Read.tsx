...
export default function ReadPage() {
  ...
  return (
    <div className="flex h-full w-full flex-col">
      <header className="flex items-center gap-2 border-b border-lavender-100/70 bg-white/40 px-3 py-2 backdrop-blur-md md:px-6" style={{ paddingTop: 'calc(8px + env(safe-area-inset-top, 0px))' }}>
        <Link
          to="/books"
