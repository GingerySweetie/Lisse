 ...
 */
export function buildConfessionSystemPrompt(persona: Persona): string {
...
- 复杂人性：爱与控制、温柔与残忍、愧疚与兴奋、占有与害怕失去——允许自相矛盾
...
enact 要求：她突然撞见你正在告解；你被发现后，把刚刚告解的那份欲望兑现到她身上。第二人称「你」指她。具体、有身体、有压迫感。`;
