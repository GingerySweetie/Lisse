...
/**
 * A file artifact generated by the AI (e.g. an HTML page, Markdown doc, or
 * code snippet). Extracted from [file name=X]…[/file] tags in the response.
 */
export interface Artifact {
  id: string;
  /** User-visible filename, e.g. "report.html". */
  name: string;
...
export interface Message {
  ...
  thinking?: string;
  /** AI-generated file artifacts extracted from [file name=X]…[/file] tags. */
  artifacts?: Artifact[];
